...
-- Insert Into interactWith Table --

INSERT INTO InteractsWith (drug_id, interacts_with_name)
SELECT drug_id, TRIM(interacts_with1) FROM DRUGS_FULL WHERE interacts_with1 IS NOT NULL
UNION
SELECT drug_id, TRIM(interacts_with2) FROM DRUGS_FULL WHERE interacts_with2 IS NOT NULL
UNION
SELECT drug_id, TRIM(interacts_with3) FROM DRUGS_FULL WHERE interacts_with3 IS NOT NULL;
