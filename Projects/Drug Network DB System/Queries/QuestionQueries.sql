...
SELECT DISTINCT d1.drug_name AS interacting_drug
FROM InteractsWith iw
JOIN Drug d1 ON iw.drug_id = d1.drug_id
JOIN Drug d2 ON LOWER(iw.interacts_with_name) = LOWER(d2.drug_name)
WHERE LOWER(d2.drug_name) = 'butabarbital';
